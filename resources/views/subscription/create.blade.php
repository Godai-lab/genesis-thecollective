            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="max-w-2xl mx-auto">
                        <form action="{{ route('subscription.store')}}" method="POST" data-validate="true">
                            @csrf 
                            <x-dynamic-form 
                                :fields="[
                                    ['label'=>'Usuario','type'=>'select', 'name'=>'user_id', 'id'=>'user_id', 'col'=>'sm:col-span-4', 'value'=>old('user_id'), 'list'=>$users],
                                    ['label'=>'Plan','type'=>'select', 'name'=>'plan_id', 'id'=>'plan_id', 'col'=>'sm:col-span-4', 'value'=>old('plan_id'), 'list'=>$plans],
                                ]" 
                            >
                                <h2 class="text-base font-semibold leading-7 text-black">Registro de suscripción</h2>

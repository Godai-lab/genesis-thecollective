<style>
    ...
    <div id="step-4-form">
        <div id="step-4-form-content">
            <form id="step4Form" method="POST" action="{{route('validar-concepto.saveValidarConcepto')}}" data-validate="true">
                @csrf
                <!--nuevos campos -->
                ...
                <div id="ResultadoConcepto" class="mb-4">
                   ...
                   <div class="flex items-center gap-4 mt-4">
                    ...
                    <div class="">
                        <input type="hidden" name="validarConcepto" id="validarConcepto" data-validation-rules="required" data-field-name="concepto">
                    </div>
                </div>
                <!--fin nuevos campos -->
                ...
                <div class="mt-6 flex items-center flex-wrap justify-end gap-x-6 gap-y-2">
                    ...
                    <x-button-genesis type="button" data-btnForm="guardarConceptoForm" class="form-button">Guardar</x-button-genesis>
                    <x-button-genesis style="display: none;" type="button" data-route="{{route('validar-concepto.mejorarConcepto')}}" data-btnForm="mejorarConceptoForm">Mejorar concepto</x-button-genesis>
                </div>
            </form>
        </div>
    </div>    
                    ...
                    <div class="mt-6">
                        <div id="categories-container" class="flex flex-wrap gap-2">
                            @foreach($categories as $category)
                                <button type="button" 
                                    class="category-tag px-2 py-2 rounded-full text-sm font-medium transition-all duration-200 border-2 border-gray-600 bg-transparent text-black dark:text-gray-300 hover:border-gray-400 dark:hover:border-gray-500 cursor-pointer"
                        ...
                        <p class="mt-3 text-xs text-gray-500 dark:text-gray-500">
                            <span id="selected-count">0</span> / 2 seleccionados
                        </p>
                    </div>
                </div>
            </div>

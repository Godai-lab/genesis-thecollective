<x-app-layout>
    <x-slot name="title">Génesis - Rol - Index</x-slot>
    <x-slot name="header">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                            ...
                            <div class="flex items-center flex-wrap justify-start gap-3">
                                ...
                                <div class="flex">
                                    <div class="flex align-middle">
                                        ...
                                        <x-dynamic-button-link :type="'clean'" :action="route('role.index')" />
                                    </div>
                                </div>
                            </div>
                        </form>
                    ...
                    <x-dynamic-table 
                        :thead="['Nombre','Descripción','Control total','Fecha creación','Fecha actualización']" 
                        :tbody="['name','description','full_access','created_at','updated_at']" 
                        :route="'role'" 
                        :data="$roles" >
                    </x-dynamic-table>
                </div>

<x-app-layout>
    <x-slot name="title">Génesis - ServiciosPlanes - Index</x-slot>
    <x-slot name="header">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="block">
                        <form method="GET" action="{{route('planServiceLimits.index')}}">
                            <div class="flex items-center justify-start space-x-3">
                                ...
                                <div class="flex">
                                    <div class="flex align-middle">
                                        ...
                                        <x-dynamic-button-link :type="'clean'" :action="route('planServiceLimits.index')" />
                                    </div>
                                </div>
                            </div>
                        </form>
                    ...
                    <x-dynamic-table 
                        :thead="['Servicio','Plan','Cant Peticiones']" 
                        :tbody="['service_name','plan.name','monthly_limit']" 
                        :route="'planServiceLimits'" 
                        :data="$planServiceLimits" >
                    </x-dynamic-table>
                </div>
            </div>
        </div>

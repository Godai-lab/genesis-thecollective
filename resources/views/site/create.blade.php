<x-app-layout>
    <x-slot name="title">Génesis - Sitios - Crear</x-slot>
    <x-slot name="header">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="max-w-2xl mx-auto">
                        <form action="{{ route('account.site.store',$account->id)}}" method="POST" enctype="multipart/form-data" onSubmit="return  ValidarCampos(this)">
                            @csrf 
                            <x-dynamic-form 
                                :fields="[
                                ...
                                >
                                <h2 class="text-base font-semibold leading-7 text-gray-100">Registro de sitio</h2>

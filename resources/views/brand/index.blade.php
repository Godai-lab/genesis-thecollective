        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                            ...
                            <div class="flex items-center justify-start space-x-3">
                                ...
                                <div class="flex">
                                    <div class="flex align-middle">
                                        ...
                                        <x-dynamic-button-link :type="'clean'" :action="route('brand.index')" />
                                    </div>
                                </div>
                            </div>
                        </form>
                    ...
                    <x-dynamic-table 
                        :thead="['Nombre','Descripción','Estado','Fecha creación','Fecha actualización']" 
                        :tbody="['name','description','status','created_at','updated_at']" 
                        :route="'brand'" 
                        :data="$brands" >
                    </x-dynamic-table>
                </div>

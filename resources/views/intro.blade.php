            ...
            <div class="h-auto w-full flex flex-col gap-40 justify-center items-center">
                ...
                <div class="flex flex-col gap-20 justify-center items-center">
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        {{-- <x-button-genesis href="https://forms.gle/76W7LUoLNHdTBCAY7" class="text-xl">Pre registro</x-button-genesis> --}}
                    </div>
                    
                </div>
                
                <div class="flex flex-col gap-20 w-full justify-between relative">
                    <div class="">Aquí comienza todo con Génesis, una plataforma integrada con los modelos de inteligencia artificial más importantes y potentes del mercado, frameworks de pensamiento, data optimizada que potenciarán tus habilidades humanas.</div>

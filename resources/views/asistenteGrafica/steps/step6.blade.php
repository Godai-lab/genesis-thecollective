...
<div id="step-4-form">
    <div id="step-4-form-content">
        <form id="step-4-form" method="POST" action="{{route('asistenteGrafica.generarExperimental')}}" enctype="multipart/form-data" data-validate="true">
            @csrf 
            <x-dynamic-form 
                :fields="[
